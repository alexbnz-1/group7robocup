...
class RecordingReplayTests(unittest.TestCase):
    ...
    def test_navigation_has_fast_sensing_and_non_stopping_diagnostics(self):
        ...
        self.assertIn("WALL_FOLLOW_DEADBAND_MM = 10", source)
        self.assertIn("SWEEP_LATERAL_DEADBAND_MM = 15", source)
        self.assertIn("captureSweepSideReferences", source)
        self.assertIn("LANE_SPACING_MM = 250.0f", source)
        self.assertIn("SWEEP_LANE_COUNT = 10", source)
